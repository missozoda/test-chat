<template>
  <div class="shadow-box shadow-5 h-[calc(100vh-100px)] mb-4">
    <div class="header grid grid-cols-4">
      <div class="col-span-3 bg-[#002955]/10 py-[12px] xl:py-[16px] 2xl:py-[18px] pl-[26px] text-[18px] min-[450px]:text-[24px] md:text-[28px] font-medium text-[#002955]">{{ $t('during_the_day') }}</div>
      <div class="col-span-1 bg-white py-[6px] sm:py-[10px] xl:py-[12px] 2xl:py-[16px] mx-auto text-base sm:text-xl text-[#002955] text-center">{{ $t('february') }}
    ...
    <q-scroll-area :thumb-style="thumbStyle" :bar-style="barStyle" class="h-[85%]">
      <div class="mx-[18px] sm:mx-[24px] mt-[16px] md:mt-[28px] mb-[20px] md:mb-[36px]">
        <div class="grid grid-cols-4 mb-[18px]" v-for="dailyData in dailyDatas" :key="dailyData" >
          ...
          <div class="col-span-3 text-sm min-[450px]:text-lg mb-[6px] sm:mb-[10px] text-[#58636F]">{{ $t('number_of_requests_received') }}</div>
          <div class="col-span-1 text-base min-[450px]:text-xl mb-[4px] sm:mb-[8px] text-end text-[#031529]">{{dailyData.allApp}}</div>
          <div class="col-span-3 text-sm min-[450px]:text-lg mb-[10px] sm:mb-[14px] text-[#58636F]">{{ $t('number_of_responses') }}</div>
