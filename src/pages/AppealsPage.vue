<template>
  <q-page class="flex item-start justify-center py-[36px] pl-[20px] md:pl-[32px] pr-[18px]">
      <div class="shadow-box shadow-5 w-full">
        <div class="flex justify-between flex-nowrap w-full pt-[27px] pb-[22px]">
